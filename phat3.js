(function(){
    // Tìm tất cả container ytp-container
    const containers = document.querySelectorAll('.ytp-container');
    ...
    containers.forEach(container => {
        ...
        container.innerHTML = `
            ...
            <div class="ytp-inner">
                <div class="ytp-player-wrap">
                    <div id="ytp-player-${Math.random().toString(36).substr(2,8)}"></div>
                ...
                <div class="ytp-playlist-section">
                    <div class="ytp-playlist ytp-playlist-list"></div>
        ...
        const playerId = inner.querySelector('[id^="ytp-player-"]').id;
        ...
        function updateUI(){
            ...
            if(playBtn) playBtn.innerHTML = player.getPlayerState()===1 ? "⏸" : "▶";
        }
        ...
        if(playBtn) playBtn.onclick=()=>{ if(!player) return; player.getPlayerState()===1?player.pauseVideo():player.playVideo(); };
                ...
                events: {
                    onReady: (e)=>{
                        ...
                        if(list && list.length){
                            ...
                            if(playlistDiv) playlistDiv.innerHTML = '<div style="padding:20px;text-align:center">Không tìm thấy video. Kiểm tra lại ID kênh/playlist.</div>';
                        }
                    },
